...
class GetCrewListUseCase @Inject constructor(private val repository: OnBoardingRepository) {
    suspend operator fun invoke() : CrewListData {
        return repository.getCrewList()
    }
}