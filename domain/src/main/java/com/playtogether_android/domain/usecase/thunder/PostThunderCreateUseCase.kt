...
class PostThunderCreateUseCase(private val repository: ThunderCreateRepository) {
    suspend operator fun invoke(crewId : Int, postThunderCreateData : PostThunderCreateData) : GetThunderCreateData{
